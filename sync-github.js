...
try {
  ...
  execSync(`"${gitExe}" commit -m "feat: Tone-mapping brightness algorithm with highlight roll-off to prevent overexposure"`, { stdio: 'pipe' });
  ...
  console.log(`\n🎉 Successfully pushed brightness optimization to GitHub: https://github.com/spurbro/${repoName}`);
} catch (err) {
